...
enum NodeType {
  ...
  /* CONST */
  NODETYPE_CONST,                      /*   Node to indicate a variable is a const   */
  NODETYPE_NOT_CONST,                  /*   Node to indicate a variable is not const */
  ...
  NODETYPE_EXPR_PREN,                  /*            Node for pren expressions       */
